...
@section('title', 'Tambah Kategori — Our Stock')
        ...
        <div class="page-header animate-fade-up">
            <div class="relative z-10 flex items-center gap-4">
                ...
                <div>
                    ...
                    <h1 class="text-2xl font-800 text-white" style="font-weight:800;">Tambah Kategori</h1>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('kategori.store') }}">
            ...
            <div class="card p-6 space-y-5 animate-fade-up" style="animation-delay:.15s;opacity:0;animation-fill-mode:both;">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nama_kategori" class="input-field @error('nama_kategori') border-red-400 @enderror" style="padding-left:2.5rem;" placeholder="cth: Elektronik, Alat Tulis" value="{{ old('nama_kategori') }}" required autofocus>
                    </div>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3" class="input-field @error('deskripsi') border-red-400 @enderror" placeholder="Deskripsi singkat (opsional)" style="resize:vertical;min-height:80px;">{{ old('deskripsi') }}</textarea>
            ...
            <div class="flex items-center gap-3 animate-fade-up" style="animation-delay:.25s;opacity:0;animation-fill-mode:both;margin-top:1.25rem;">
                ...
                <button type="submit" class="btn-primary flex-1">
                    <i data-lucide="plus" style="width:16px;height:16px;"></i> Simpan Kategori
                </button>
            </div>
        </form>
    </div>
