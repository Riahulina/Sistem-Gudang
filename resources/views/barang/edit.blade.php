...
@section('title', 'Edit Barang — Our Stock')
        ...
        <div class="page-header animate-fade-up">
            <div class="relative z-10 flex items-center gap-4">
                ...
                <div>
                    ...
                    <h1 class="text-2xl font-800 text-white" style="font-weight:800;">Edit Barang</h1>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('barang.update', $barang) }}">
            ...
            <div class="card p-6 space-y-5 animate-fade-up" style="animation-delay:.1s;opacity:0;animation-fill-mode:both;">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kode_barang" class="input-field" style="padding-left:2.5rem;" value="{{ old('kode_barang', $barang->kode_barang) }}" required>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_barang" class="input-field" value="{{ old('nama_barang', $barang->nama_barang) }}" required>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-600 text-slate-700 mb-1.5" style="font-weight:600;">Stok <span class="text-red-400">*</span></label>
                        <input type="number" name="stok" class="input-field" min="0" value="{{ old('stok', $barang->stok) }}" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="satuan" class="input-field" value="{{ old('satuan', $barang->satuan) }}" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="minimum_stok" class="input-field" min="0" value="{{ old('minimum_stok', $barang->minimum_stok) }}" required>
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="2" class="input-field" style="resize:vertical;">{{ old('keterangan', $barang->keterangan) }}</textarea>
                </div>
            </div>
